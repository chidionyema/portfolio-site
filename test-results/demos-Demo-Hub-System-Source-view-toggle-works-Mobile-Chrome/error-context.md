...
- Name: demos.spec.ts >> Demo Hub >> System/Source view toggle works
- Location: tests/e2e/demos.spec.ts:87:3
...
- generic [active] [ref=e1]:
  ...
  - button "Toggle live cluster console" [ref=e291] [cursor=pointer]:
    ...
    - generic [ref=e297]: ·
    - generic "Frontend bundle started 2026-05-18T16:11:34.213Z (2m ago)" [ref=e298]: web:4f9a7e7 2m
    - generic [ref=e299]: ·
    - generic [ref=e300]: "0"
    - img [ref=e302]
```
