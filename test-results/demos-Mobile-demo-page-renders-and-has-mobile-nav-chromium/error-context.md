...
- Name: demos.spec.ts >> Mobile >> demo page renders and has mobile nav
- Location: tests/e2e/demos.spec.ts:187:3
...
- generic [active] [ref=e1]:
  ...
  - button "Toggle live cluster console" [ref=e265] [cursor=pointer]:
    ...
    - generic [ref=e271]: ·
    - generic "Frontend bundle started 2026-05-18T16:11:34.213Z (56s ago)" [ref=e272]: web:4f9a7e7 56s
    - generic [ref=e273]: ·
    - generic [ref=e274]: "0"
    - img [ref=e276]
```
