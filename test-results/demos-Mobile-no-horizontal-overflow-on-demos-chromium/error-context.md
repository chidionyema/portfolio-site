...
- Name: demos.spec.ts >> Mobile >> no horizontal overflow on demos
- Location: tests/e2e/demos.spec.ts:196:3
...
- generic [active] [ref=e1]:
  ...
  - button "Toggle live cluster console" [ref=e315] [cursor=pointer]:
    ...
    - generic [ref=e321]: ·
    - generic "Frontend bundle started 2026-05-18T16:11:34.213Z (56s ago)" [ref=e322]: web:4f9a7e7 56s
    - generic [ref=e323]: ·
    - generic [ref=e324]: "0"
    - img [ref=e326]
```
