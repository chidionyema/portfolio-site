                     ...
                     <div className="flex p-1 bg-black/40 rounded-xl border border-white/5 sm:mr-2">
                        <button
                          ...
                          className={cn(
                            ...
                            viewMode === "live" ? "bg-accent text-white shadow-lg" : "text-secondary/70 hover:text-primary"
                          )}
                        >
                        ...
                        <button
                          ...
                          className={cn(
                            "focus-ring flex items-center gap-1.5 sm:gap-2 px-2.5 sm:px-3 py-1.5 rounded-lg text-[9px] font-black uppercase tracking-widest transition-all",
                            viewMode === "source" ? "bg-accent text-white shadow-lg" : "text-secondary/70 hover:text-primary"
                          )}
                        >
                        ...
                        {(() => {
                           ...
                           return src ? (
                              <a
                                ...
                                className="inline-flex items-center gap-2 px-3 py-2 bg-white/10 hover:bg-white/10 border border-white/10 rounded-lg text-[10px] font-black uppercase tracking-widest text-secondary hover:text-primary transition-all group/src"
