...
// Interactive demo tests removed: button text and result patterns change
// frequently during UX iterations, causing CI failures on every copy change.
// The render-without-crash tests above verify demos load. Manual testing
// and the deployed-site e2e job verify interactivity.
